...
Scope {
    ...
    component CornerPanelWindow: PanelWindow {
        ...
        RoundCorner {
            ...
            implicitHeight: Math.max(implicitSize, sidebarCornerOpenInteractionLoader.implicitHeight + 2)
            ...
            Loader {
                ...
                anchors {
                    ...
                    topMargin: (cornerWidget.isTopLeft || cornerWidget.isTopRight) ? 2 : 0
                    bottomMargin: (cornerWidget.isBottomLeft || cornerWidget.isBottomRight) ? 2 : 0
                }
