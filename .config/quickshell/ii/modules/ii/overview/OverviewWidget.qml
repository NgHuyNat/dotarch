                            ...
                            MouseArea {
                                ...
                                onPressed: {
                                    if (root.draggingTargetWorkspace === -1) {
                                        ...
                                        Quickshell.execDetached(["hyprctl", "dispatch", "workspace", `${workspace.workspaceValue}`])
                                    }
                                }
                            }
                    ...
                    MouseArea {
                        ...
                        onReleased: {
                            ...
                            if (targetWorkspace !== -1 && targetWorkspace !== windowData?.workspace.id) {
                                Quickshell.execDetached(["hyprctl", "dispatch", "movetoworkspacesilent", `${targetWorkspace},address:${window.windowData?.address}`])
