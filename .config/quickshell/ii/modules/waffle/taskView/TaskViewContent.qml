                            ...
                            onActiveChanged: {
                                if (active) {
                                    ...
                                    if (root.hoveredWorkspace !== null && root.hoveredWorkspace.workspace !== windowItem.hyprlandClient.workspace.id) {
                                        Quickshell.execDetached(["hyprctl", "dispatch", "movetoworkspacesilent", `${root.hoveredWorkspace.workspace},address:${windowItem.hyprlandClient.address}`]);
                                    } else {
            ...
            WListView {
                ...
                delegate: TaskViewWorkspace {
                    ...
                    onClicked: {
                        ...
                        Quickshell.execDetached(["hyprctl", "dispatch", "workspace", `${workspaceItem.workspace}`]);
                    }
                }
            }
        }
